...
This module is responsible for:
  - Loading and caching the YOLO11 object detection model.
...
class VehicleDetector:
    ...
    def get_model(cls) -> YOLO:
        """
        Return the singleton YOLO11 model instance, loading weights on first call.
        ...
        if cls._model is None:
            target_model = settings.YOLO_MODEL_NAME or "yolo11n.pt"
